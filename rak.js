...
*/
	...
	// Type check array of promises for group operations
	var checkPromises = function(promises) {
		if(!Array.isArray(promises))
			throw new TypeError('Must supply an array of promises');
		for(var i=0; i<promises.length; i++) {
			if(typeof constructors[promises[i].constructor.name] === 'undefined' 
					|| !constructors[promises[i].constructor.name])
